...
final class PDFService {
    func createFlyer() -> PDFDocument {
      // 1
      let pdfMetaData = [
        kCGPDFContextCreator: "Flyer Builder",
        kCGPDFContextAuthor: "raywenderlich.com",
        kCGPDFContextTitle: "HalaMadrid"
      ]
    ...
    func addTitle(pageRect: CGRect) -> CGFloat {
      ...
      let attributedTitle = NSAttributedString(string: "HalaMadrid", attributes: titleAttributes)
      // 3
    ...
    func addBodyText(pageRect: CGRect, textTop: CGFloat) {
      ...
      let attributedText = NSAttributedString(string: "Hello world", attributes: textAttributes)
      // 4
    ...
    func drawContactLabels(_ drawContext: CGContext, pageRect: CGRect, numberTabs: Int) {
      ...
      let attributedContactText = NSMutableAttributedString(string: "Ramos", attributes: contactBlurbAttributes)
      // 1
